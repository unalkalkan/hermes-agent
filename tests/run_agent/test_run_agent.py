...
def test_aiagent_uses_opencode_acp_client():
    with (
        patch("run_agent.get_tool_definitions", return_value=_make_tool_defs("web_search")),
        patch("run_agent.check_toolset_requirements", return_value={}),
        patch("run_agent.OpenAI") as mock_openai,
        ...
        agent = AIAgent(
            api_key="opencode-acp",
            base_url="acp://opencode",
            provider="opencode-acp",
            acp_command="/usr/local/bin/opencode",
            acp_args=["acp"],
            quiet_mode=True,
            skip_context_files=True,
            skip_memory=True,
    ...
    mock_openai.assert_not_called()
    mock_acp_client.assert_called_once()
    assert mock_acp_client.call_args.kwargs["base_url"] == "acp://opencode"
    assert mock_acp_client.call_args.kwargs["api_key"] == "opencode-acp"
    assert mock_acp_client.call_args.kwargs["command"] == "/usr/local/bin/opencode"
