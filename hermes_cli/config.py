...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "HERMES_COPILOT_ACP_COMMAND", "COPILOT_CLI_PATH", "HERMES_COPILOT_ACP_ARGS", "COPILOT_ACP_BASE_URL",
    "HERMES_OPENCODE_ACP_COMMAND", "OPENCODE_CLI_PATH", "HERMES_OPENCODE_ACP_ARGS", "OPENCODE_ACP_BASE_URL",
